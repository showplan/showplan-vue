import { PhysicalOp } from 'showplan-js';
...
const GetOperationType = (physicalOp: PhysicalOp): operationType => {
    switch (physicalOp) {
        case 'Constant Scan':
...
const GetOperationColor = (physicalOp: PhysicalOp): string => Colors[GetOperationType(physicalOp)];
